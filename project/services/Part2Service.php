...
class Part2Service implements StepInterface
{
    ...
    public function Postgres_Oracle()
    {
        ...
        $row1 = pg_fetch_row(pg_query($connect->connectionDB($configurations, 1), $select1));
        $row2 = oci_fetch_row(oci_parse($connect->connectionDB($configurations, 2), $select2));
    ...
    public function Oracle_Oracle()
    {
        ...
        $res = oci_parse($connect->connectionDB($configurations, 1), "SELECT column_name, data_type FROM information_schema.columns WHERE table_schema = '" . $schema1 . "' AND table_name = '" . $table1 . "' ORDER BY ordinal_position");
        ...
        $row1 = oci_fetch_row(oci_parse($connect->connectionDB($configurations, 1), $select1));
        $row2 = oci_fetch_row(oci_parse($connect->connectionDB($configurations, 2), $select2));
